...
const url = process.env.NEXT_PUBLIC_SUPABASE_URL ?? 'https://xmmwytmljbszzsluvqiu.supabase.co';
const key = process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY ?? 'sb_publishable_FC2Gw6SoRjnZmxO5jU2Grg_mlbUpHeY';
